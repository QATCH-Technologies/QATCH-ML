...
Extracted verbatim from the top-level ``v7_yolo.py`` module as part of the
``inference/`` subpackage split. All values are unchanged from the original
``QModelV6Config`` — this is a pure relocation, not a retune.
"""
