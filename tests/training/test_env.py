...
class TestStageResult:
    ...
    def test_instantiation_without_metrics(self):
        ...
        assert result.metrics is None  # [cite: 7]
    ...
    def test_instantiation_with_metrics(self):
        ...
        result = env.StageResult(
            stage="fill_classifier", weights_path=path, metrics=metrics
        )  # [cite: 7]
...
class TestExtractMetrics:
    ...
    def test_extracts_from_train_return_results_dict(self):
        ...
        mock_return.results_dict = {"precision": 0.95}  # [cite: 7]
    ...
    def test_extracts_from_model_metrics_results_dict(self):
        ...
        mock_model.metrics.results_dict = {"recall": 0.92}  # [cite: 7]

        # Pass None as the train_return to force fallback[cite: 7]
    ...
    def test_extracts_via_to_dict_method(self):
        ...
        mock_return.to_dict.return_value = {"f1_score": 0.88}  # [cite: 7]
    ...
    def test_handles_to_dict_exception_gracefully(self):
        ...
        mock_return.to_dict.side_effect = Exception("Internal Ultralytics error")  # [cite: 7]

        metrics = env.extract_metrics(train_return=mock_return)
        # Should not raise the Exception, but instead return None[cite: 7]
    ...
    def test_returns_none_if_no_metrics_found(self):
        ...
        # Neither None nor arbitrary strings have results_dict or to_dict()[cite: 7]
