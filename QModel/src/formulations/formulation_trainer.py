...
# ---------------------------
df = pd.read_csv(r"FormulaTRaining_v2.csv")
...
# ---------------------------
# 4. XGBoost Models (One per target)
# ---------------------------
...
for col in Y.columns:
    ...
    model_filename = f"xgboost_model_{col}.json"
...
# Optionally, you might want to save the dictionary of models using joblib:
