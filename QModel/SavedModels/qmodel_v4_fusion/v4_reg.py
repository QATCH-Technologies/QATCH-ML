...
from fusion_dataprocessor import FusionDataprocessor as DP
import warnings

warnings.filterwarnings('ignore')


class UniversalPOIModel(nn.Module):
    ...
    def __init__(self, window_size: int, feature_dim: int, config: Dict[str, any]):
        super(UniversalPOIModel, self).__init__()
...
class RegressionPOIPredictor:
    ...
    def predict(self,
        ...
        # Generate features
        features_df = DP.get_features(df)
...
class MultiPOIPredictor:
    ...
    def __init__(self, model_configs: Dict[str, str], device: str = None):
        ...
        for poi_name, model_path in model_configs.items():
            ...
            self.predictors[poi_name] = RegressionPOIPredictor(
...
if __name__ == "__main__":
    ...
    predictor = RegressionPOIPredictor(
