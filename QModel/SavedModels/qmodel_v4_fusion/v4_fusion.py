...
if __name__ == "__main__":
    ...
    classification_paths = {
        'model': 'fusion/fusion_models/v4_model_pytorch.pth',
        'scaler': 'fusion/fusion_models/v4_scaler_pytorch.joblib',
        'config': 'fusion/fusion_models/v4_config_pytorch.json'
    }

    regression_paths = {
        'POI1': 'fusion/fusion_models/poi_model_mini_window_0.pth',
        'POI2': 'fusion/fusion_models/poi_model_small_window_1.pth',
        'POI4': 'fusion/fusion_models/poi_model_med_window_3.pth',
        'POI5': 'fusion/fusion_models/poi_model_large_window_4.pth',
        'POI6': 'fusion/fusion_models/poi_model_small_window_5.pth'
    }
    ...
    for data, poi in content:
        ...
        # Visualize results
        predictor.visualize(result, save_path='hybrid_prediction.png')
